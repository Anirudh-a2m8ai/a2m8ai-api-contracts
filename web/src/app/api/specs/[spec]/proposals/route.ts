...
/** GET /api/specs/:spec/proposals — every edit request, open ones first. */
export async function GET(_request: Request, { params }: Params) {
  return guard(async () => {
    ...
    return Response.json(
      { proposals: await listProposals(spec) },
...
/**
 * POST /api/specs/:spec/proposals — open an edit request.
 *
...
export async function POST(request: Request, { params }: Params) {
  return guard(async () => {
    ...
    const proposal = await createProposal(spec, {
